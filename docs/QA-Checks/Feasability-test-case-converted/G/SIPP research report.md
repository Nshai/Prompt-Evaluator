...
[**How are risk levels used to create suitable investment portfolios?** 4](#_Toc3)
...
| CT Universal MAP Balanced Fund C Acc (GBP) | Columbia Threadneedle Fund Management Limited | GB00BF99W060 | ![](data:image/png;base64...) | N/A ![](data:image/png;base64...) | ![](data:image/png;base64...) | 50.00 |
| HSBC Global Strategy Balanced Portfolio Accumulation C (GBP) | HSBC Asset Management (Fund Services UK) Limited | GB00B76WP695 | ![](data:image/png;base64...) | N/A ![](data:image/png;base64...) | ![](data:image/png;base64...) | 50.00 |
...
| CT Sustainable Universal MAP Balanced C Acc | Columbia Threadneedle Fund Management Limited | GB00BKV44860 | ![](data:image/png;base64...) | N/A ![](data:image/png;base64...) |
| CT Universal MAP Balanced Fund C Acc | Columbia Threadneedle Fund Management Limited | GB00BF99W060 | ![](data:image/png;base64...) | N/A ![](data:image/png;base64...) |
| CT Universal MAP Income Fund C Inc | Columbia Threadneedle Fund Management Limited | GB00BK5ZC812 | ![](data:image/png;base64...) | ![](data:image/png;base64...) |
| HSBC Global Strategy Balanced Portfolio Accumulation C | HSBC Asset Management (Fund Services UK) Limited | GB00B76WP695 | ![](data:image/png;base64...) | N/A ![](data:image/png;base64...) |
| Legal & General Multi-Index 5 Fund I Class Accumulation | Legal & General (Unit Trust Managers) Ltd | GB00B8VZ3F59 | ![](data:image/png;base64...) | N/A ![](data:image/png;base64...) |
| Vanguard LifeStrategy 60% Equity Fund A Acc | Vanguard Investments UK, Limited | GB00B3TYHH97 | ![](data:image/png;base64...) | ![](data:image/png;base64...) |
