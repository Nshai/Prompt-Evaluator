...
public class SectionSlotTests
{
    ...
    public void ANamedSectionSurvivesAFullPackOfBetterScoringSiblings()
    {
        ...
        var ranked = CheckPlanRunner.Rank(passages, new HashSet<string> { "B" }, ["Residency"]);
    ...
    public void WithoutTheDeclarationTheSamePassageIsEvicted()
    {
        ...
        var ranked = CheckPlanRunner.Rank(passages, new HashSet<string> { "B" });
    ...
    public void TheReservationDoesNotDisplaceTheRestOfTheRanking()
    {
        ...
        var ranked = CheckPlanRunner.Rank(passages, new HashSet<string> { "B" }, ["Current Monthly Cash Flow"]);
    ...
    public void ADeclarationMatchingNothingDoesNotConsumeASlot()
    {
        ...
        var withHint = CheckPlanRunner.Rank(passages, new HashSet<string> { "B" }, ["Existing Pension Provision"]);
        var without = CheckPlanRunner.Rank(passages, new HashSet<string> { "B" });
    ...
    public void ThePackDoesNotDependOnTheOrderSectionsWereListed()
    {
        ...
        var one = CheckPlanRunner.Rank(passages, new HashSet<string> { "B" },
            ["Current Monthly Cash Flow", "Total Net Monthly Income"]);
        var two = CheckPlanRunner.Rank(passages, new HashSet<string> { "B" },
