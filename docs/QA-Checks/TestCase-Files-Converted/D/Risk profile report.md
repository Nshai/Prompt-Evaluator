---
source_file: "Risk profile report.docx"
source_format: "docx"
source_bytes: 176084
source_sha256: "ea6e7f6537a6c3b818d8016b665176ec1e76057995b91169bf2c4e6f13c50cd9"
converter: "Markdown.FileConverter 1.0.0"
---

![Picture 1](Risk profile report.assets/img-0001.png)
...
![Text Box 2](Risk profile report.assets/img-0002.png)

![Picture 4](Risk profile report.assets/img-0003.png)

![Picture 4](Risk profile report.assets/img-0004.png)
...
Your natural risk level is based on the answers given in the Attitude to Risk Questionnaire which was completed on 18/09/2025. The responses can be found in the appendix

**XXXXXXXX**

| **4<br><br>Cautious Balanced** |  | **As a Cautious Balanced investor you tend to see yourself as quite a cautious person and are inclined to view risk negatively rather than as a source of opportunity.  If you have limited or moderate experience of investments and do not find financial matters particularly easy to understand then you may be suited to a Cautious Balanced approach to investing.  You may also be suited to this approach if you take some time to make investment decisions and tend to be somewhat anxious about those decisions.  As a Cautious Balanced investor you are inclined to look for safer investments, although you may consider taking some risk in exchange for increased potential returns.** |  
...
![Picture 8](Risk profile report.assets/img-0005.png)

Investment Projection Graph based on Natural Risk Level

|  |  

![Picture 10](Risk profile report.assets/img-0006.png)

Investment Projection Graph based on Agreed Risk Level

|  |  

![Picture 12](Risk profile report.assets/img-0007.png)
